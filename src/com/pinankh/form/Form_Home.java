package com.pinankh.form;

import com.pinankh.dialog.Message;
import com.pinankh.main.Main;
import com.pinankh.model.ModelCard;
import com.pinankh.model.ModelStudent;
import com.pinankh.swing.icon.GoogleMaterialDesignIcons;
import com.pinankh.swing.icon.IconFontSwing;
import com.pinankh.swing.noticeboard.ModelNoticeBoard;
import com.pinankh.swing.table.EventAction;
...
public class Form_Home extends javax.swing.JPanel {
    ...
    private void initTableData() {
        ...
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/pinankh/icon/user_defualt.png")), "Jonh", "Male", "Java", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/pinankh/icon/user_defualt.png")), "Dara", "Male", "C++", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/pinankh/icon/user_defualt.png")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/pinankh/icon/user_defualt.png")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/pinankh/icon/user_defualt.png")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/pinankh/icon/user_defualt.png")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
        table1.addRow(new ModelStudent(new ImageIcon(getClass().getResource("/com/pinankh/icon/user_defualt.png")), "Bora", "Male", "C#", 300).toRowTable(eventAction));
    ...
    private void initComponents() {
        ...
        card1 = new com.pinankh.component.Card();
        jLabel1 = new javax.swing.JLabel();
        card2 = new com.pinankh.component.Card();
        card3 = new com.pinankh.component.Card();
        card4 = new com.pinankh.component.Card();
        jPanel1 = new javax.swing.JPanel();
        noticeBoard = new com.pinankh.swing.noticeboard.NoticeBoard();
        ...
        table1 = new com.pinankh.swing.table.Table();
    ...
    private com.pinankh.component.Card card1;
    private com.pinankh.component.Card card2;
    private com.pinankh.component.Card card3;
    private com.pinankh.component.Card card4;
    ...
    private com.pinankh.swing.noticeboard.NoticeBoard noticeBoard;
    private com.pinankh.swing.table.Table table1;
